...
output.to_csv('/workspaces/Housing-Sales/submission.csv', index=False)

# Display the first few rows of the submission file
output.head()

# Optionally, update the sample submission
sample_submission_df = pd.read_csv('/workspaces/Housing-Sales/sample_submission.csv')
sample_submission_df['SalePrice'] = preds.squeeze()
sample_submission_df.to_csv('/workspaces/Housing-Sales/sample_submission.csv', index=False)
